...
import { Course } from '../RTK_Query'

const CourseInfoCard: React.FC<Course> = ({
	title, description, rate, students, createdBy, updatedAt
}) => {
	return (
		<section className="bg-gray-200 hover:bg-gray-300 dark:bg-gray-900">
			<div className="py-10 px-4 mx-auto max-w-screen-xl">
				<h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-white">{title}</h1>
				<p className="mb-4 text-lg text-justify font-normal text-gray-500 dark:text-gray-400">{description}</p>
				<div className="flex justify-start items-center space-x-4">
					<div className="flex items-center">
						...
						<p className="ml-2 text-lg font-semibold text-gray-500 dark:text-gray-400">{rate} rating</p>
					</div>
					<p className="text-lg font-semibold">{students} students</p>
				</div>
				<div className="mt-2 flex justify-start items-center space-x-4 font-semibold">
					<p>
						...
						<span className="text-lg">{createdBy}</span>
					</p>
					<p>
						<span className="text-gray-500 font-normal">Last Updated At: </span>
						<span className="text-lg">{updatedAt}</span>
					</p>
				</div>
			</div>
		</section>
